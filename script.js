...
const writerPipeline = (
  ...
  { stage: 'done', delay: 4200, message: 'Документы подписаны ЭП и сохранены в архиве ALтехник' },
];
  ...
  pue: [
    {
      ...
      table: {
        head: ['Категория', 'Требование', 'Применение ALтехник'],
        rows: [
          ['I', 'Две независимые источника питания', 'Щиты собственных нужд и ИБП ALтехник'],
    ...
    },
    {
      ...
      table: {
        ...
        rows: [
          ['Медь', '16', 'Для кабельных линий ALтехник'],
...
const substationInfo = {
  ...
  kru10: {
    title: 'КРУ-10 кВ',
    description: 'Шкафы ALтехник серии AL-K, трансформаторы 2,5-6,3 МВА',
